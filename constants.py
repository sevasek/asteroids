...
AUDIO_COMBO_DURATIONS = [0.1, 0.2, 2.0, 2.0, 0.3, 0.3, 0.3]
AUDIO_CHORD_MINOR_THIRD = 1.2
AUDIO_CHORD_FIFTH = 1.5
AUDIO_CHORD_OCTAVE_DOWN = 0.5
AUDIO_CHORD_OCTAVE_UP = 2.0
AUDIO_DECAY_RATE = 3.0
AUDIO_STACCATO_RATE = 15.0
AUDIO_SUSTAIN_FADE_START = 0.85
AUDIO_AMP_ROOT_PRIMARY = 0.8
AUDIO_AMP_ROOT_SECONDARY = 0.7
AUDIO_AMP_ROOT_CHORD = 0.5
AUDIO_AMP_ROOT_FULL = 0.35
AUDIO_AMP_THIRD = 0.3
AUDIO_AMP_FIFTH = 0.3
AUDIO_AMP_THIRD_LIGHT = 0.25
AUDIO_AMP_FIFTH_LIGHT = 0.2
AUDIO_AMP_BASS = 0.6
AUDIO_AMP_BASS_LIGHT = 0.5
AUDIO_AMP_HIGH_STACCATO = 0.7
